...
| `docs/sprints/` | Bitácora de sprints del Second Brain (objetivo, resultados, pendientes): `Sprint-00.md`, `Sprint-01.md`, `Sprint-02.md`, `Sprint-03.md` |

**Idea clave a recordar en todo momento:** TaskLab no debe tratarse como "un gestor de tareas más". A partir del Sprint 01 se define como **un sistema para preservar el contexto y la trazabilidad de las decisiones que originan el desarrollo de software** (ver `docs/decisiones/D-002-el-problema-es-la-perdida-de-contexto.md`), a partir del Sprint 02 aspira a ser la **memoria operativa del desarrollo de software** (ver `docs/decisiones/D-003-el-tiempo-mas-caro-es-el-de-comprension.md`), y a partir del Sprint 03 incorpora **Ready to Understand** como concepto central: cualquier petición debería poder evaluarse antes de llegar a desarrollo para saber si contiene suficiente información para ser comprendida sin depender de conocimiento implícito (ver `docs/producto/ready-to-understand.md` y `docs/decisiones/D-004-ready-to-understand-como-concepto-central.md`). No compite inicialmente con Jira/Linear/Shortcut/Trello/ClickUp — se integra con ellos (ver `docs/decisiones/001-no-competir-con-jira.md` y `docs/decisiones/D-001-no-competir-con-jira.md`). Cualquier sugerencia de producto o arquitectura debe respetar este posicionamiento salvo indicación expresa en contra.

**Estado del Second Brain:** Sprints 00 a 03 completados (ver `docs/sprints/`). El problema documentado en `docs/second-brain/02-problema.md` sigue siendo una **hipótesis**, ahora validada externamente con equipos de desarrollo (`docs/investigacion/validacion-externa.md`) y respaldada por los casos reales (`docs/casos/`), los patrones detectados (`docs/investigacion/patrones.md`, P-001 a P-011) y el flujo mental del desarrollador (`docs/investigacion/flujo-del-desarrollador.md`). Hipótesis pendientes de validar más a fondo: `docs/validaciones/H-001-expediente-completo.md`, `docs/validaciones/H-002-tiempo-de-comprension.md`, `docs/validaciones/H-003-ready-to-understand.md`. Existe un primer modelo de dominio provisional en `docs/producto/modelo-del-dominio.md`. Próximo sprint: diseñar el primer MVP de TaskLab.
