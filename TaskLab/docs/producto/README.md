...
> Plantilla inicial. Este espacio documenta las decisiones y definiciones de producto de TaskLab (features, alcance, prioridades funcionales).

## Propósito de esta carpeta

Reunir la definición funcional del producto: qué hace TaskLab, para quién, y por qué se construye cada feature de esta manera.

## Contenido esperado

- Definiciones de features (qué problema resuelve, cómo funciona a alto nivel)
