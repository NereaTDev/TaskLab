            ...
            <div class="flex items-center gap-4">
              ...
              <div class="inline-flex items-center gap-1 rounded-full bg-slate-900 px-1 py-1 text-xs">
                <a href="{{ route('tasks.index') }}"
                   class="inline-flex text-sm items-center gap-1.5 rounded-full px-3 py-1.5 font-medium {{ request()->routeIs('tasks.index') && in_array(request()->get('view'), [null, 'dashboard'], true) ? 'bg-tasklab-bg text-tasklab-text' : 'text-tasklab-muted hover:text-tasklab-text' }}">
                ...
                <a href="{{ route('tasks.index') }}?view=board"
                   class="inline-flex text-sm items-center gap-1.5 rounded-full px-3 py-1.5 font-medium {{ request()->get('view') === 'board' ? 'bg-tasklab-bg text-tasklab-text' : 'text-tasklab-muted hover:text-tasklab-text' }}">
                  <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('tasks.index') }}?view=analysis"
                   class="inline-flex text-sm items-center gap-1.5 rounded-full px-3 py-1.5 font-medium {{ request()->get('view') === 'analysis' ? 'bg-tasklab-bg text-tasklab-text' : 'text-tasklab-muted hover:text-tasklab-text' }}">
                  <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @auth
                  @if (auth()->user()->is_admin)
                    <a href="{{ route('team.index') }}"
                       class="inline-flex text-sm items-center gap-1.5 rounded-full px-3 py-1.5 font-medium {{ request()->routeIs('team.index') ? 'bg-tasklab-bg text-tasklab-text' : 'text-tasklab-muted hover:text-tasklab-text' }}">
                      <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
