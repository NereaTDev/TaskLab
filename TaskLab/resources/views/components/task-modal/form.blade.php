  ...
  <div class="space-y-3 overflow-y-auto pl-2 min-h-0">
    ...
    <section class="rounded-xl border border-slate-800 bg-tasklab-bg-muted p-3 space-y-3 text-label text-tasklab-muted">
      ...
      <div class="border-t border-slate-800 pt-3 space-y-3">
        <div>
          ...
          <select name="status" class="w-full rounded-lg border border-slate-700 bg-tasklab-bg text-body text-tasklab-text px-2 py-1.5 text-sm" x-model="modalTask.status" :disabled="modalMode === 'view'">
        ...
        <div>
          ...
          <select name="type" class="w-full rounded-lg border border-slate-700 bg-tasklab-bg text-body text-tasklab-text px-2 py-1.5 text-sm" x-model="modalTask.type" :disabled="modalMode === 'view'">
        ...
        <div>
          ...
          <select name="priority" class="w-full rounded-lg border border-slate-700 bg-tasklab-bg text-body text-tasklab-text px-2 py-1.5 text-sm" x-model="modalTask.priority" :disabled="modalMode === 'view'">
    ...
    <section class="rounded-xl border border-slate-800 bg-tasklab-bg-muted p-3 space-y-3 text-label text-tasklab-muted">
      <div>
        ...
        <select name="points" class="w-full rounded-lg border border-slate-700 bg-tasklab-bg text-body text-tasklab-text px-2 py-1.5 text-sm" :disabled="modalMode === 'view'">
  ...
  <div class="flex items-center gap-2">
    ...
    <template x-if="modalMode === 'view'">
      <div class="flex items-center gap-2">
        ...
        <button type="button" class="inline-flex items-center justify-center rounded-full bg-tasklab-accent px-4 py-1.5 text-body font-medium text-slate-950 hover:bg-tasklab-accent-soft" @click.prevent="enterEditMode()">Editar</button>
      </div>
    </template>

    <template x-if="modalMode === 'edit'">
      <div class="flex items-center gap-2">
        <button type="button" class="inline-flex items-center justify-center rounded-full border border-slate-700 bg-tasklab-bg px-4 py-1.5 text-body text-tasklab-muted hover:text-tasklab-text hover:border-tasklab-accent" @click.prevent="cancelEditMode()">Cancelar edición</button>
        <button type="submit" class="inline-flex items-center justify-center rounded-full bg-tasklab-accent px-4 py-1.5 text-body font-medium text-slate-950 hover:bg-tasklab-accent-soft">Guardar cambios</button>
      </div>
    </template>
  </div>
</div>
