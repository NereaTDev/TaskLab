    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <form method="POST" action="{{ route('tasks.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="block text-label font-medium text-tasklab-muted mb-1">Area</label>
                    <select name="area" class="w-full rounded-md border border-slate-700 bg-tasklab-bg-muted px-2 py-1.5 text-body text-tasklab-text">
                ...
                <div>
                    <label class="block text-label font-medium text-tasklab-muted mb-1">Effort</label>
                    <select name="estimated_effort" class="w-full rounded-md border border-slate-700 bg-tasklab-bg-muted px-2 py-1.5 text-body text-tasklab-text">
